...
st.write("Heart Disease Risk Predictor — patient details neeche fill karein.")
...
if st.button("🔍 Predict", type="primary", use_container_width=True):
    # Map form values to the exact column names/order the model was trained on
    values = {
        "age": age,
    ...
    st.caption("Ye ek machine learning estimate hai, medical diagnosis nahi. Kisi bhi real health concern ke liye doctor se consult karein.")
